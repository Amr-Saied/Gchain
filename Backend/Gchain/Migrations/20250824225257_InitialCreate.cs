        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxLivesPerPlayer = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RevivalUsed = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WordGuesses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WordGuesses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WordGuesses_GameSessions_GameSessionId",
                        column: x => x.GameSessionId,
                        principalTable: "GameSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoundResults_Teams_WinningTeamId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TeamChatMessages_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TeamId = table.Column<int>(type: "int", nullable: false),
                    MistakesRemaining = table.Column<int>(type: "int", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    JoinOrder = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoundResults_GameSessionId",
                table: "RoundResults",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoundResults_WinningTeamId",
                table: "RoundResults",
                column: "WinningTeamId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamChatMessages_CreatedAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamChatMessages_UserId",
                table: "TeamChatMessages",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WordGuesses_GameSessionId",
                table: "WordGuesses",
                column: "GameSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_WordGuesses_GameSessionId_RoundNumber",
                table: "WordGuesses",
                columns: new[] { "GameSessionId", "RoundNumber" });

            migrationBuilder.CreateIndex(
                name: "IX_WordGuesses_UserId",
                table: "WordGuesses",
                column: "UserId");
        }
